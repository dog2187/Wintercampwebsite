...
this.velocity = createVector(randomXVelocity(x), random(-10, -10));
...
Fruit.prototype.draw = function() {
  ...
  if (this.sliced) {
    ...
    fillColor = lerpColor(this.color, color(51, 250, 23, 0), interp); 
  }
...
//randomize the position
  ...
  var size = noise(frameCount) * 25 + 25; //Randomize the size
